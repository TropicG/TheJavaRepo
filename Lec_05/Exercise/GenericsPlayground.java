...
public class GenericsPlayground {
    ...
    private static void getHumans(List<? extends Human> listOfHumans){
        ...
        // we are safe to rely on always getting a Human
        for(Human h : listOfHumans) {
            System.out.println(h.getName());
        }

        // we cannot add any element to the list, because the compiler cannot guarantee type safety
        // The only option to this is adding null
