...
public class EchoClientNio {
    ...
    public static void main(String[] args) {
        ...
        // creating the socketChannel for the client
        try (SocketChannel socketChannel = SocketChannel.open();
             Scanner scanner = new Scanner(System.in)) {

            // connecting the socket channel to the client
            ...
            while (true) {
                ...
                // sending information to the server over the networ
                ...
                // receiving infromation from the server into the client
                buffer.clear(); // switch to writing mode
